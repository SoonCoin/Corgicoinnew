...
public:
    ...
    void setupUi(QDialog *OptionsDialog)
    {
        ...
        gridLayout = new QGridLayout(tabWindow);
        ...
        gridLayout->addWidget(minimizeOnClose, 1, 0, 1, 2);

        comboBoxThemes = new QValueComboBox(tabWindow);
        comboBoxThemes->setObjectName(QStringLiteral("comboBoxThemes"));
        comboBoxThemes->setMaximumSize(QSize(100, 23));

        gridLayout->addWidget(comboBoxThemes, 2, 1, 1, 1);

        minimizeToTray = new QCheckBox(tabWindow);
        minimizeToTray->setObjectName(QStringLiteral("minimizeToTray"));

        gridLayout->addWidget(minimizeToTray, 0, 0, 1, 3);

        verticalSpacer_Window = new QSpacerItem(20, 20, QSizePolicy::Minimum, QSizePolicy::Expanding);

        gridLayout->addItem(verticalSpacer_Window, 3, 0, 1, 3);
    ...
    void retranslateUi(QDialog *OptionsDialog)
    {
        ...
        bitcoinAtStartup->setToolTip(QApplication::translate("OptionsDialog", "Automatically start corgicoin after logging in to the system.", 0));
#endif // QT_NO_TOOLTIP
        bitcoinAtStartup->setText(QApplication::translate("OptionsDialog", "&Start corgicoin on system login", 0));
#ifndef QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        mapPortUpnp->setToolTip(QApplication::translate("OptionsDialog", "Automatically open the corgicoin client port on the router. This only works when your router supports UPnP and it is enabled.", 0));
#endif // QT_NO_TOOLTIP
        mapPortUpnp->setText(QApplication::translate("OptionsDialog", "Map port using &UPnP", 0));
#ifndef QT_NO_TOOLTIP
        connectSocks->setToolTip(QApplication::translate("OptionsDialog", "Connect to the corgicoin network through a SOCKS proxy (e.g. when connecting through Tor).", 0));
#endif // QT_NO_TOOLTIP
        ...
        label->setText(QApplication::translate("OptionsDialog", "Theme", 0));
#ifndef QT_NO_TOOLTIP
        ...
        comboBoxThemes->clear();
        comboBoxThemes->insertItems(0, QStringList()
         << QApplication::translate("OptionsDialog", "Dark Style", 0)
         << QApplication::translate("OptionsDialog", "Light Style", 0)
        );
#ifndef QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        lang->setToolTip(QApplication::translate("OptionsDialog", "The user interface language can be set here. This setting will take effect after restarting corgicoin.", 0));
#endif // QT_NO_TOOLTIP
...
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_TOOLTIP
        displayAddresses->setToolTip(QApplication::translate("OptionsDialog", "Whether to show corgicoin addresses in the transaction list or not.", 0));
#endif // QT_NO_TOOLTIP
