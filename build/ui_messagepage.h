...
public:
    ...
    void setupUi(QWidget *MessagePage)
    {
        ...
        listConversation->setStyleSheet(QStringLiteral("color: rgb(1, 1, 1);"));
...
#ifndef QT_NO_TOOLTIP
        sendButton->setToolTip(QApplication::translate("MessagePage", "Sign a message to prove you own a corgicoin address", 0));
#endif // QT_NO_TOOLTIP
