...
public:
    ...
    void setupUi(QDialog *CoinControlDialog)
    {
        ...
        labelCoinControlAmount->setText(QStringLiteral("0.00 CORG"));
        ...
        labelCoinControlFee->setText(QStringLiteral("0.00 CORG"));
        ...
        labelCoinControlAfterFee->setText(QStringLiteral("0.00 CORG"));
        ...
        labelCoinControlChange->setText(QStringLiteral("0.00 CORG"));
