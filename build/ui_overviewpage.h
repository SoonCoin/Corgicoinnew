...
public:
    ...
    void setupUi(QWidget *OverviewPage)
    {
        ...
        labelBalance->setText(QStringLiteral("0 CORG"));
        ...
        labelStake->setText(QStringLiteral("0 CORG"));
        ...
        labelUnconfirmed->setText(QStringLiteral("0 CORG"));
        ...
        labelImmature->setText(QStringLiteral("0 CORG"));
        ...
        formLayout_2->setWidget(6, QFormLayout::SpanningRole, line);

        labelTotalText = new QLabel(frame);
        labelTotalText->setObjectName(QStringLiteral("labelTotalText"));

        formLayout_2->setWidget(8, QFormLayout::LabelRole, labelTotalText);

        labelTotal = new QLabel(frame);
        labelTotal->setObjectName(QStringLiteral("labelTotal"));
        labelTotal->setFont(font1);
        labelTotal->setCursor(QCursor(Qt::IBeamCursor));
        labelTotal->setText(QStringLiteral("0 CORG"));
        labelTotal->setTextInteractionFlags(Qt::LinksAccessibleByMouse|Qt::TextSelectableByKeyboard|Qt::TextSelectableByMouse);

        formLayout_2->setWidget(8, QFormLayout::FieldRole, labelTotal);


        verticalLayout_4->addLayout(formLayout_2);

        inwalletlogo = new QLabel(frame);
        inwalletlogo->setObjectName(QStringLiteral("inwalletlogo"));
        inwalletlogo->setMinimumSize(QSize(256, 256));
        inwalletlogo->setStyleSheet(QStringLiteral("image: url(:/qdarkstyle/corgicoin.png);"));
        inwalletlogo->setFrameShape(QFrame::NoFrame);
        inwalletlogo->setFrameShadow(QFrame::Plain);
        inwalletlogo->setPixmap(QPixmap(QString::fromUtf8("../res/images/corgicoin.png")));
        inwalletlogo->setScaledContents(false);
        inwalletlogo->setAlignment(Qt::AlignCenter);
        inwalletlogo->setOpenExternalLinks(false);

        verticalLayout_4->addWidget(inwalletlogo);
    ...
    void retranslateUi(QWidget *OverviewPage)
    {
        ...
        labelWalletStatus->setToolTip(QApplication::translate("OverviewPage", "The displayed information may be out of date. Your wallet automatically synchronizes with the corgicoin network after a connection is established, but this process has not completed yet.", 0));
#endif // QT_NO_TOOLTIP
...
#endif // QT_NO_TOOLTIP
        inwalletlogo->setText(QString());
        label_4->setText(QApplication::translate("OverviewPage", "<b>Recent transactions</b>", 0));
#ifndef QT_NO_TOOLTIP
        labelTransactionsStatus->setToolTip(QApplication::translate("OverviewPage", "The displayed information may be out of date. Your wallet automatically synchronizes with the corgicoin network after a connection is established, but this process has not completed yet.", 0));
#endif // QT_NO_TOOLTIP
    } // retranslateUi
